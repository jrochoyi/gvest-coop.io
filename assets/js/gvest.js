...
$(window).resize(function() {
  // to reset the seq for charts drawing animations
  seq = seq2 = 0;
...
paperDashboard = {
  ...
  initMinimizeSidebar: function() {
    ...
    $('#minimizeSidebar').click(function() {
      ...
      // to simulate the window Resize so the charts will get updated in realtime.
      var simulateWindowResize = setInterval(function() {
        window.dispatchEvent(new Event('resize'));
      }, 180);

      // to stop the simulation of Window Resize after the animations are completed
      setTimeout(function() {
